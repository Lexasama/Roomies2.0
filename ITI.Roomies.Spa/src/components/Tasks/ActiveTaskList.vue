                    ...
                    <el-table :data="activeTaskList" height="250" style="width: 100%">
                        <el-table-column prop="state" label="State" width="100">
                            <template slot-scope="scope">
                                <el-button round icon="el-icon-circle-check"
                                           @click="updateState(scope.row)"></el-button>
                            </template>
                        </el-table-column>
                        <el-table-column prop="taskDate" label="date" :formatter="dateFormatter"
                            ...
                            <template slot-scope="scope">
                                <el-button-group>
                                    ...
                                    <el-button size="mini" icon="el-icon-delete"
                                               @click="deleteTask(scope.row)"></el-button>
                                </el-button-group>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
  import {deleteTaskAsync, getColocFilteredTasksAsync, updateStateAsync} from "@/api/TaskApi";
  ...
  export default {
        ...
        methods: {
            ...
            dateFormatter(row, colunm) {
              ...
              return c.getDate() + "/" + (c.getMonth() + 1) + "/" + c.getFullYear() + " " + c.getHours() + ":" + c.getMinutes();
            },
