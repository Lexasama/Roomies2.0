...
(
    ...
    constraint FK_tGoogleUser_UserId foreign key(UserId) references rm2.tUser(UserId),
    constraint UK_tGoogleUser_GoogleId unique(GoogleId)
);

insert into rm2.tGoogleUser(UserId, GoogleId, RefreshToken) values(0, 0, '');
